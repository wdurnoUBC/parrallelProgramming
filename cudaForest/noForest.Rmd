...
```{r}
samp = c(100,200,300,400) ; sCuda = c(1851256,8661865,27840086,52645273) ; sSerial = c(41462,713985,1579860,3608384)
trees = c(10,15,20,25,30); tCuda = c(3634180,3376250,3576120,4171166,5332446) ; tSerial = c(86230,123688,157630,193027,249004)
plot(samp,sCuda,col='red',type='l',lwd=3 , ylim=c(min(c(sCuda,sSerial)),max(c(sCuda,sSerial))) , main="CUDA (red) vs. CPU (blue) with trees = 5" , xlab="Sample size" , ylab="Microseconds = 10^(-6)s" )
lines(samp,sSerial,col='blue',lwd=3)
plot(trees,tCuda,col='red',type='l',lwd=3 , ylim=c(min(c(tCuda,tSerial)),max(c(tCuda,tSerial))) , main="CUDA (red) vs. CPU (blue) with samp = 100" , xlab="Trees" , ylab="Microseconds = 10^(-6)s" )
...
plot( fl , cpu , col='blue' , type ='l' , lwd=3 , main="CUDA (red) vs. CPU (blue) in float summing" , xlab="N" , ylab="microseconds = 10^(-6)s" )
...
```{r}
plot( fl , cpu/gpu , col='blue' , type ='l' , lwd=3 , main="Speedup in float summing" , xlab="N" , ylab="fold speedup" )
```
...
plot( fl , (cpu/gpu)/eff , col='blue' , type ='l' , lwd=3 , main="Efficiency in float summing" , xlab="N" , ylab="Efficiency" )
```
